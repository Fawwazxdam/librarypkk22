@extends('layouts.app')
@section('content')
<h2 class="text-center m-3">User</h2>
    ...
    <tbody>
        @foreach ($data as $user)
            <tr>
                ...
                <td>{{ $user->name }}</td>
                <td>{{ $user->role }}</td>
                <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit{{$user->id}}">Edit</button></td>
                <td><a href="{{url('delus/'.$user->id)}}" class="btn btn-primary">Delete</a></td>
            </tr>
